		...
		<div class="box">
			<div class="box-body">
				...
				<table id="datatable1" class="table table-bordered table-hover">
					...
					<tbody>
						<?php $no = 1; foreach ($color as $color): ?>
							<tr>
								<td><?php echo $no;?></td>
								<!-- <td> -->
									<!-- <img src="<?php echo base_url($path_file.'/'.$thumb_pre.$color->color_image);?>" class="img img-responsive" alt="<?php echo $color->color_alt;?>"> -->
								<!-- </td> -->
								<td><?php echo $color->color_name;?></td>
								<!-- <td> -->
									<!-- <div class="text-scroll"> -->
										<!-- <?php echo nl2br($color->color_desc);?> -->
									<!-- </div> -->
								<!-- </td> -->
								<td>
									<!-- Action -->
									<?php if ($color->color_pub == '88'): ?>
										<a href="<?php echo site_url('admin/color/publish/'.$color->color_id);?>" class="btn btn-flat btn-danger" title="Publish">
											<i class="fa fa-bullhorn"></i>
										</a>
									<?php else: ?>
										<a href="<?php echo site_url('admin/color/publish/'.$color->color_id);?>" class="btn btn-flat btn-success" title="Publish">
											<i class="fa fa-bullhorn"></i>
										</a>
									<?php endif ?>
...
<!--
				<div class="form-group">
					<label for="color">Description (max 300 chars)</label>
					<textarea name="desc" class="form-control" placeholder="description" rows="5" maxlength="300" required></textarea>
				</div>
				<div class="form-group">
					<label for="color">Image Alt</label>
					<input type="text" name="alt" class="form-control" placeholder="color image alt" required>
				</div>
				<div class="form-group">
...
<!--
				<div class="form-group">
					<label for="color">Review (max 300 chars)</label>
					<textarea id="desc" name="desc" class="form-control" placeholder="description" rows="5" maxlength="300" required></textarea>
				</div>
				<div class="form-group">
					<label for="color">Image Alt</label>
					<input id="alt" type="text" name="alt" class="form-control" placeholder="color image alt" required>
				</div>
				<div class="form-group">
					<label for="color">Image</label>
					<input type="file" name="image" class="form-control">
