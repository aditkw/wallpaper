		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
					...
					<li class="active">Konfirmasi Transfer</li>
				</ol>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container -->
						...
						<div class="col-md-8 col-md-offset-2">
							<div class="box-login">
								<div class="tag-konten">
									<div class="nama-tag-konten font-20">KONFIRMASI PEMBAYARAN</div>
								</div><!-- /.tag-konten -->
								<div class="row">
										...
										<div class="col-sm-6">
											...
											<div class="form-group">
												...
												<div class="has-feedback">
													...
													<span class="glyphicon glyphicon-calendar form-control-feedback text-abu"></span>
												</div>
											</div>
