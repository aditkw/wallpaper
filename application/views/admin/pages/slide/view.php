						...
						<tbody>
							<?php $no = 1; foreach ($slide as $slide): ?>
								<tr>
									<td><?php echo $no;?></td>
									<td>
										<img src="<?php echo base_url($path_file.'/'.$thumb_pre.$slide->banner_image);?>" class="img img-responsive" alt="<?php echo $slide->banner_alt;?>">
									</td>
									...
									<td>
										...
										<?php if ($slide->banner_pub == '88'): ?>
											<a href="<?php echo site_url('admin/slide/publish/'.$slide->banner_id);?>" class="btn btn-flat btn-danger" title="Publish">
												<i class="fa fa-bullhorn"></i>
											</a>
										<?php else: ?>
											<a href="<?php echo site_url('admin/slide/publish/'.$slide->banner_id);?>" class="btn btn-flat btn-success" title="Publish">
												<i class="fa fa-bullhorn"></i>
											</a>
										<?php endif ?>
										<a class="btn btn-flat btn-default btn-edit-slide" data-id="<?php echo $slide->banner_id;?>" title="Update">
											<i class="fa fa-edit"></i>
										</a>
										<a onclick="return confirm('Are you sure ?')"  href="<?php echo site_url('admin/slide/delete/'.$slide->banner_id);?>" class="btn btn-warning btn-flat" title="Delete">
...
<div id="add" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			...
			<?php echo form_open_multipart('admin/slide/insert');?>
...
<div id="update" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			...
			<?php echo form_open_multipart('admin/slide/update');?>
			<div class="modal-body">
				<div class="form-group">
					<label for="slide">Link</label>
